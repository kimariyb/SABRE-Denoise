...
from models.dncnn import DnCNN1D
...
LR_PATIENCE = 5
SAVE_INTERVAL = 1
CHECKPOINT_DIR = '../checkpoints/dncnn'
LOG_DIR = '../logs/dncnn'
...
def main():
    ...
    # Create model
    model = DnCNN1D(depth=20, n_feats=128).to(DEVICE)
    ...
    for epoch in range(EPOCHES):
        ...
        val_loss   = eval_fn(model, val_loader, loss_fn, DEVICE)
